...
public interface ClinicService {
    ...
    Collection<Vet> findVetByLastName(String lastName) throws  DataAccessException;

    Collection<Vet> findVetByFirstNameLastName(String firstName, String lastName) throws  DataAccessException;
    ...
    Collection<PetType> findPetAge() throws DataAccessException;
